...
from app.services.file_loader import load_dataframe as _shared_load_dataframe
...
class ValidationChainEngine:
    ...
    def _load_dataframe(file_path: str, file_info: FileDetectionResult) -> Optional[pd.DataFrame]:
        # Delegates to the shared loader (app.services.file_loader) so this
        # logic isn't duplicated between structural and business-rule validation.
        return _shared_load_dataframe(file_path, file_info)
